;(function(global, $) {
    ...
    $(document).ready( function( ) {
        ...
        $( '.img-frame img' ).on( 'load', function( ) { centerImage( this ); });
...
// Check whether all the "needles" are found in the "haystack"
    function match_categories( haystack, needles ) {
        for ( var i = 0; i < haystack.length; i++ ) {
            var idx = needles.indexOf( haystack.eq( i ).text( ).toLowerCase( ));
            if ( -1 != idx ) {
    ...
    function displayImages( ) {
        ...
        $( 'div#announcement' ).fadeOut( fade, function( ) {
            $( 'div#images' ).fadeIn( fade, function( ) {
                setTimeout( function( ) { nextImage( 0 ); }, nextItemTimeout );
            });
        });
    }
            ...
            $.ajax( 'get.php', {
                ...
                success : function( json, textStatus, jqXHR ) {
                    if ( json.error ) {
                        ...
                        frame++;
                        if ( frame < 4 ) {
                            setTimeout( function( ) { nextImage( frame )}, nextItemTimeout );
                        } else {
